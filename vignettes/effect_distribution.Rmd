...
Note also that there is no strong relationship between the allele frequency and the effect size by default. 
...
sim_dat1a <- sim_mv(G = 1,
                   ...
                   S = -1)
with(sim_dat1a, plot(beta_joint[beta_joint != 0] ~ snp_info$AF[beta_joint != 0]))
```
...
sim_dat1b <- sim_mv(G = 1,
                   ...
                   af = function(n){rbeta(n, 1, 1)},
                   S = 1)
with(sim_dat1b, plot(beta_joint[beta_joint != 0] ~ snp_info$AF[beta_joint != 0]))
```
